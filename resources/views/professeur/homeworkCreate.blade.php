      ...
      <div class="main-panel">
        ...
        <div class="container">
          <div class="page-inner">
            ...
            <form action="{{ route('professeur.homework.store') }}" method="POST" enctype="multipart/form-data">
                @csrf
                <div class="form-group">
                    <label for="Titre_Devoir">Titre du Devoir</label>
                    <input type="text" name="Titre_Devoir" id="Titre_Devoir" class="form-control" required>
                </div>
                <div class="form-group">
                    <label for="Description_Devoir">Description</label>
                    <textarea name="Description_Devoir" id="Description_Devoir" class="form-control" rows="4"></textarea>
                </div>
                <div class="form-group">
