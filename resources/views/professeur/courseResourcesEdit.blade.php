      ...
      <div class="main-panel">
        ...
        <div class="container">
          <div class="page-inner">
            ...
            <h1>Modifier la ressource: {{ $resource->title }}</h1>
            <form action="{{ route('professeur.courseResources.update', $resource->id) }}" method="POST" enctype="multipart/form-data">
                @csrf
                @method('PUT')
                ...
                <div class="form-group">
                    ...
                    <textarea name="description" id="description" class="form-control">{{ $resource->description }}</textarea>
                </div>
                <div class="form-group">
