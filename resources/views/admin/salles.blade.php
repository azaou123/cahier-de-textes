      ...
      <div class="main-panel">
        ...
        <div class="container">
          <div class="page-inner">
            ...
            <a href="{{ route('admin.salles.create') }}" class="btn btn-success">Créer une Salle</a>
            <table class="table">
                <thead>
                    <tr>
                        <th>ID</th>
                ...
                <tbody>
                    @foreach($salles as $salle)
                        <tr>
                            ...
                            <td>
                                <a href="{{ route('admin.salles.edit', $salle->ID_Salle) }}" class="btn btn-primary">Modifier</a>
